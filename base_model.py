...
class BaseModel:
    ...
    def run_eval(self, news_filename, behaviors_file):
        ...
        """
        print(self.support_quick_scoring,'support_quick_scoring')
        #support_quick_scoring默认为True
    ...
    def news(self, batch_news_input):
        #这是一batch的news，news是从yibatch中获得的news_index[0,1,2,3,....31]
    ...
    def run_fast_eval(self, news_filename, behaviors_file):
        ...
        #获得每个用户点解了哪些新闻，按照每个batch读取数据，32*400，
        user_vecs = self.run_user(news_filename, behaviors_file)
        #按照每个batch把news和user编码存储了
