...
class NAMLModel(BaseModel):
    ...
    def _build_userencoder(self, newsencoder):
        ...
        his_input_title_body_verts = keras.Input(
            shape=(hparams.his_size, hparams.title_size + hparams.body_size + 2 + 10),
            dtype="int32",
        )
        #(50,400)
    ...
    def _build_newsencoder(self, embedding_layer,entity_embedding_layer):
        ...
        input_title_body_verts = keras.Input(
            shape=(hparams.title_size + hparams.body_size + 2+10,), dtype="int32"
        )
    ...
    def _build_naml(self):
        ...
        his_title_body_verts = layers.Concatenate(axis=-1)([his_input_title, his_input_body, his_input_vert, his_input_subvert,his_input_entity])

        pred_title_body_verts = layers.Concatenate(axis=-1)([pred_input_title, pred_input_body, pred_input_vert, pred_input_subvert,pred_input_entity])
