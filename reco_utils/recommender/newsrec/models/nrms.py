...
class NRMSModel(BaseModel):
    ...
    def _build_titleencoder(self, embedding_layer):
        ...
        embeddings3 = embedding_layer(sequences_input_title)
        # r = 5
        # # CAM注意机制
        ...
        # fc2_avg = tf.contrib.layers.fully_connected(inputs=fc1_avg, num_outputs=30)
        #
        ...
        # fc2_max = tf.contrib.layers.fully_connected(inputs=fc1_max, num_outputs=30)
        #
        ...
        # )(y)
        y = layers.Dropout(hparams.dropout)(embeddings3)
        y = SelfAttention(hparams.head_num, hparams.head_dim, seed=self.seed)(
            [y] * 3
        )
        pred_title = AttLayer2(hparams.attention_hidden_dim, seed=self.seed)(y)
    ...
    def _build_bodyencoder(self, embedding_layer):
        ...
        embeddings3 = embedding_layer(sequences_input_body)
