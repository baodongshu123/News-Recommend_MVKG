...
from reco_utils.recommender.newsrec.models.layers import PersonalizedAttentivePooling, AttLayer2, SelfAttention
...
class NRMSModel(BaseModel):
    ...
    def _build_userencoder(self, titleencoder,news_encoder):
        ...
        #     seed=self.seed,
        # )([news_present, layers.Dense(hparams.attention_hidden_dim)(short_uemb)])
        #
        ...
        model = keras.Model(
            his_input_title_body_verts, user_present_final, name="user_encoder"
        )
        return model
    ...
    def _build_nrms(self):
        ...
        pred_input_title_2 = pred_input_title
        ...
        pred_title_body_verts = layers.Concatenate(axis=-1)(
            [pred_input_title_2, pred_input_body, pred_input_vert]
        )
        ...
        pred_title_one_reshape = layers.Reshape((81,))(pred_title_body_verts_one)
        ...
        news_present2 = news_present
        self.userencoder = self._build_userencoder(titleencoder,self.newsencoder)
        user_present = self.userencoder([his_title_body_verts,pred_title_body_verts])
        ...
        '''
            ValueError: Graph disconnected: cannot obtain value for tensor Tensor("input_4:0", shape=(?, 5, 30), dtype=int32)
             at layer "input_4". The following previous layers were accessed without issue: ['input_9', 'input_8', 'input_7']
