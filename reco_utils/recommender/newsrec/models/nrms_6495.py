...
class NRMSModel(BaseModel):
    ...
    def _build_newsencoder(self, embedding_layer):
        ...
        # y_drop2_title_repr = layers.Dropout(hparams.dropout)(drop_title_repr)
    ...
    def _build_titleencoder(self, embedding_layer):
        ...
        x = Bidirectional(LSTM(100, return_sequences=True))(embedded_sequences_title)
        y = layers.Dropout(hparams.dropout)(x)
    ...
    def _build_bodyencoder(self, embedding_layer):
        ...
        x = Bidirectional(LSTM(100, return_sequences=True))(embedded_sequences_body)
        y = layers.Dropout(hparams.dropout)(x)
