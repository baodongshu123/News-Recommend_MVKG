...
class NRMSModel(BaseModel):
    ...
    def _build_vertencoder(self):
        ...
        y = layers.Dropout(hparams.dropout)(vert_emb)
        y = SelfAttention(hparams.head_num, hparams.head_dim, seed=self.seed)([y, y, y])
        y = layers.Dropout(hparams.dropout)(y)
        #(?,1,400)
        pred_vert = AttLayer2(hparams.attention_hidden_dim, seed=self.seed)(y)
    ...
    def _build_subvertencoder(self):
        ...
        y = layers.Dropout(hparams.dropout)(subvert_emb)
        y = SelfAttention(hparams.head_num, hparams.head_dim, seed=self.seed)([y, y, y])
        y = layers.Dropout(hparams.dropout)(y)
        pred_subvert = AttLayer2(hparams.attention_hidden_dim, seed=self.seed)(y)
