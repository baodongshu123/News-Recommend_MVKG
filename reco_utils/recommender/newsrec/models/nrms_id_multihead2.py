...
class NRMSModel(BaseModel):
    ...
    def _build_userencoder(self, titleencoder,user_embedding_layer):
        ...
        # his_title_uid = layers.Concatenate(axis=-1)([his_input_title_body_verts, ])
        #(?,50,400)
        ...
        y = layers.Concatenate(axis=-2)([click_news_presents,u_emb])
        # u_emb = layers.Reshape((hparams.user_emb_dim,))(
        #     user_embedding_layer(user_indexes)
        # )
        #his_size:50;filter_num:400,attention_hidden_dim:200
        #click_news_presents:(?,50,400)
