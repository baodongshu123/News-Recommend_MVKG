...
class NRMSModel(BaseModel):
    ...
    def _build_userencoder(self, titleencoder,user_embedding_layer):
        ...
        u_emb_att = layers.Dense(hparams.attention_hidden_dim)(u_emb)
        ...
        user_present_att = user_present([click_news_presents, u_emb_att])
        ...
        model = keras.Model(
            [his_input_title_body_verts,user_indexes], user_present_att, name="user_encoder"
        )
        return model
