...
class NRMSModel(BaseModel):
    ...
    def _build_titleencoder(self, embedding_layer):
        ...
        # x = Bidirectional(LSTM(200, return_sequences=True))(embedded_sequences_title)

        y = layers.Dropout(hparams.dropout)(x)#(?,30,400)
        pred_title = AttLayer2(hparams.attention_hidden_dim, seed=self.seed)(y)
    ...
    def _build_titleencoder1(self, embedding_layer):
        """build title encoder of NAML news encoder.
