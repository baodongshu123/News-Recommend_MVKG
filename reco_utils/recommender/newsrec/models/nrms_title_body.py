...
class NRMSModel(BaseModel):
    ...
    def _build_userencoder(self, titleencoder):
        ...
        his_input_title_body_verts = keras.Input(
            shape=(hparams.his_size, hparams.body_size),
            dtype="int32",
        )
    ...
    def _build_newsencoder(self, embedding_layer):
        ...
        body_repr = self._build_bodyencoder(embedding_layer)(input_title_body_verts)

        y = layers.Dropout(hparams.dropout)(body_repr)
    ...
    def _build_nrms(self):
        ...
        pred_title_one_reshape = layers.Reshape((-1,))(pred_input_body_one)
        ...
        user_present = self.userencoder(his_input_body)
        news_present = layers.TimeDistributed(self.newsencoder)(pred_input_body)
